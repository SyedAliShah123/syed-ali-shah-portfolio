...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section
      id="about"
      className="py-20 sm:py-28 px-5 sm:px-6 lg:px-8 border-b border-black/10 dark:border-white/10 relative bg-[#F6F6F4] dark:bg-[#0A0A0A] text-[#0A0A0A] dark:text-white transition-colors duration-300"
    >
